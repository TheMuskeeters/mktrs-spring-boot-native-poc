...
class UserControllerTest {
    ...
    @Test
    @DisplayName("When no payload is sent, then BAD request is given.")
    void whenUserCreateNoPayloadSentShouldReturnBadRequest() {
        ...
        client.post()
            ...
            .consumeWith(response -> {
                ...
                assertThat(resBody).isEqualTo(expectedBody);
            });
    }

    @Test
    @DisplayName("When payload is empty, then BAD request is given.")
    ...
    @Test
    @DisplayName("When payload fields are null, then BAD request is given.")
    ...
    @Test
    @DisplayName("When payload fields are empty, then BAD request is given.")
    ...
    @Test
    @DisplayName("When payload field address is not empty, name is null/empty, then BAD request is given.")
    ...
    @Test
    @DisplayName("When payload field name is not empty, address is null/empty then BAD request is given.")
    void whenUserCreatePayloadFieldAddresIsNotEmptyShouldReturnBadRequest() {
        var jsonPayload = """
            {
              "name": "user",
              "address": ""
    ...
    @Test
    @DisplayName("Verify new User is Created")
